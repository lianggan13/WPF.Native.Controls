...
namespace MenuWithSubMenu
{
    class SideMenuViewModel
    {
        ...
        ResourceDictionary dict = Application.LoadComponent(new Uri("/WPFNavigate;component/Assets/IconDictionary.xaml", UriKind.RelativeOrAbsolute)) as ResourceDictionary;
    ...
    public class MenuItemsData
    {
        ...
        private void navigateToPage(string Menu)
        {
            ...
            {
                (Application.Current.MainWindow as MainWindow).MainWindowFrame.Navigate(new Uri(string.Format("{0}{1}{2}", "Pages/", Menu, ".xaml"), UriKind.RelativeOrAbsolute));
                return;
            }
