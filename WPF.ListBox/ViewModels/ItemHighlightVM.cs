...
namespace WPF.ListBox.ViewModels
{
    public class ItemHighlightVM
    {
        ResourceDictionary dict = Application.LoadComponent(new Uri("WPF.Common;component/Assets/Styles/Path.xaml", UriKind.RelativeOrAbsolute)) as ResourceDictionary;
